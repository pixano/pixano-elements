...
class MyDemo extends LitElement {
	...
	firstUpdated() {
		...
		// this.element.settings.edges = [[0,1],[1,2], [2,4], [1,3], [0,2], [1,2], [3,4]];
		// this.element.settings.vertexNames = ["Top head","R-shoulder","L-shoulder", "R-hip", "L-hip"];
	...
	render() {	 
		return html`<pxn-tracking-graph id="test"
			.tracks=${this.tracks}
			.input=${this.images}
			...
			@delete-track=${(e) => console.log('delete track', e.detail)}></pxn-tracking-graph>`;
	}
}
